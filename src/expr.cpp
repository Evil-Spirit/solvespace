...
Expr *Expr::From(double v) {
    // Using this approach can save the huge amount of memory
    // and avoid unwanted allocations. 
    // unbeliveable, but many of expressions are zeroes, ones
    // and other simple constants.
    if(v == 0.0) {
